...
synth_design -top LecturaBotones -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef LecturaBotones.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file LecturaBotones_utilization_synth.rpt -pb LecturaBotones_utilization_synth.pb"
